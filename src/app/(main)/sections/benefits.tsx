...
export default function Benefits() {
  return (
    <section id="benefits" className="cont mt-32 scroll-m-20 text-muted-foreground">
      <FadeDown>
        <div className="flex items-center justify-center">
          <AsteriskIcon className="size-8 text-brand-darker/80" />
          <span className="bg-gradient-to-b from-brand/80 to-brand bg-clip-text text-base font-medium text-transparent">
            Benefits
          </span>
        </div>
        <h3 className="mt-3 flex flex-col items-center justify-center text-center text-3xl font-medium text-muted-foreground xs:text-4xl sm:text-5xl">
      ...
      <div className="mt-10 flex flex-wrap justify-center">
        ...
        <FadeUp className="w-full pb-10 md:w-1/2 md:p-5 lg:w-1/3">
          <div className="relative flex flex-col items-center overflow-hidden rounded-3xl p-6">
            {graphics}
            <Signpost className="size-8 rotate-12 fill-foreground" />
            <h3 className="mt-3 text-center text-2xl font-semibold">
...
const graphics = (
  <>
    <div className="absolute inset-0 -z-10 rounded-3xl border-2 border-brand/25 [mask-image:linear-gradient(to_bottom,black,transparent)]" />
    <div className="absolute inset-0 -z-10 rounded-3xl border-2 border-brand/10 [mask-image:linear-gradient(to_top,black,transparent)]" />
    <div className="absolute right-0 top-0 -z-10 size-24 rounded-full bg-brand-darker/30 blur-3xl filter" />
