  ...
  return (
    <div id="how-it-works" className="scroll-m-16">
      <section className="relative overflow-hidden text-sm md:py-12">
        <div className="absolute left-0 top-0 -z-10 size-96 rounded-full bg-info/5 blur-3xl" />
        ...
        <div className="cont grid lg:grid-cols-2">
          <FadeUp className="relative h-full overflow-hidden rounded-lg lg:mr-5 xl:mr-10">
            <div className="pb-10 xs:px-2">
              <h2 className="mb-2 flex items-center space-x-1 bg-gradient-to-b from-brand/80 to-brand bg-clip-text text-lg font-medium text-transparent">
          ...
          <FadeUp className="relative flex flex-col space-y-2.5 overflow-hidden rounded-3xl px-6 pb-8 lg:ml-5 xl:ml-10">
            ...
            <div className="absolute left-0 top-0 size-20 rounded-full bg-brand-darker/30 blur-3xl filter" />
            <div className="absolute bottom-0 left-0 size-20 rounded-full bg-sky-400/30 blur-3xl filter" />
            <div className="absolute right-0 top-0 size-20 rounded-full bg-brand-darker/60 blur-3xl filter" />

            <FadeDown className="space-y-2.5" delay={0.35}>
              <div className="h-6 w-0.5 translate-x-4 rounded-full bg-purple-200/10" />
              <div className="flex items-center space-x-4">
                <div className="grid place-items-center rounded-full bg-emerald-500/20 p-1.5">
                  <CircleCheckIcon className="size-5 fill-emerald-400" />
                </div>
            ...
            <FadeDown className="space-y-2.5" delay={0.4}>
              ...
              <div className="flex items-center space-x-4">
                <div className="grid place-items-center rounded-full bg-sky-400/15 p-1.5">
                  <Clock4 className="size-5 fill-sky-400" />
                </div>
            ...
            <FadeDown delay={0.55}>
              ...
              <div className="flex items-end space-x-3">
                <div className="grid place-items-center rounded-full bg-indigo-500/15 p-1.5">
                  <Stars className="size-5 fill-brand-darker text-brand-darker" />
                </div>
                <div className="rounded-full rounded-bl-none bg-gradient-to-br from-indigo-400/10 to-sky-400/15 px-6 py-2">
                  <span>Highest bidder grabs the deal</span>
                  <PartyPopper className="ml-2 inline size-3.5 text-muted-foreground" />
                </div>
              </div>
            </FadeDown>
          </FadeUp>
