    ...
    <div className="relative flex size-full flex-col justify-between">
      ...
      <div className="grid size-full place-items-center">
        <div>
          <div className="flex flex-col items-center space-y-3">
            <span className="text-3xl font-semibold text-muted-foreground xs:text-4xl sm:text-5xl">
      ...
      <div className="mb-2 mr-6 flex flex-wrap justify-end gap-y-1 space-x-2">
        <button
          ...
          className="flex items-center space-x-2 rounded-md border border-foreground/10 px-2 py-1 text-xs"
        >
        ...
        {width < 1024 && (
          <BidsSnapshotDrawer auctionId={auction.id}>
            <button className="flex items-center space-x-2 rounded-md border border-foreground/10 px-2 py-1 text-xs">
