export default function page() {
  return (
    <div className="cont mb-20 pt-20 lg:mb-32">
      <div>
        <h1 className="mt-2 flex items-center space-x-1 text-2xl font-medium">
      ...
      <section className="mt-7 space-y-10">
        ...
        <div>
          ...
          <p className="text-indigo-200/90">Users are expected to:</p>
          <ul className="ml-4 list-disc text-indigo-200/90">
          ...
          <p className="mt-1 text-sm italic text-indigo-200/80">
